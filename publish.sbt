...
pomExtra :=
  <url>https://github.com/hypertino/hyperbus-t-zeromq</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/hyperbus-t-zeromq.git</url>
      <connection>scm:git:git@github.com:hypertino/hyperbus-t-zeromq.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
